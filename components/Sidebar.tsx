...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      <div className={`
        fixed md:relative top-0 left-0 w-[320px] sm:w-[380px] h-full 
        bg-gradient-to-b from-obsidian-light via-obsidian-light to-obsidian 
        border-r border-white/5 flex flex-col overflow-hidden 
        shadow-[20px_0_60px_-15px_rgba(0,0,0,0.8)] z-50
      ...
      `}>
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 p-2 text-white/20 hover:text-white md:hidden z-[60]"
        >
